// /[skill]-jobs SEO landing — dispatched from the [...path] catch-all.
//
// Original location: apps/web/app/[skill]-jobs/page.tsx (deleted).
// Moved into the catch-all's _handlers/ folder because Next 16 can't
// resolve multiple dynamic root-level segments at the same directory
// level — see app/[...path]/page.tsx for the full story.
