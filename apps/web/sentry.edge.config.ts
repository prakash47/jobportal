// Phase 1 item 18 — Sentry init for the Edge runtime (Next.js
// middleware). Loaded by the Next.js instrumentation hook when the
// edge runtime boots. Same shape as server but the @sentry/nextjs
// SDK uses a smaller surface here (no http instrumentation; the Edge
