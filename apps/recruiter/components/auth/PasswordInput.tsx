...
//
// Mirrors apps/sadmin/components/auth/PasswordInput.tsx — the two are
// deliberately duplicated because each Next app owns its own components tree
// and cross-app imports aren't possible (the same reason brand/Logo.tsx and
// CompanyLogo.tsx exist twice). Promoting it into @jobportal/ui would take the
// atoms-barrel lock for a component only two apps use.
