...
// Recruiter "Notification settings" — now nested under Settings (Settings →
// Notification settings). Reads the recruiter's channel preferences in the RSC
// via Prisma (reads/writes split); the client form PATCHes the BFF. L2 of the
// killswitch lives here — if an admin flips killswitch.recruiter_notifications
// ON the page 404s (L3 in the API service is the trusted, non-bypassable layer).
