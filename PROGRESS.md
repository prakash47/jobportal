...
- **Seed catalogue**: **36 flags** (+`killswitch.recruiter_post_job` this merge; +`killswitch.recruiter_help_support` prior) / 10 industries / 50 cities / 160 skills / **6 plans** (added Recruiter Starter ₹1,999/mo + Recruiter Growth ₹4,999/mo; enterprise-yearly reclassified to RECRUITER audience) / 3 articles. Plus the demo overlay (stable Job IDs 100001-100050): 12 companies / 8 recruiters (each their company's **Owner**) / 38 reviews / 50 jobs / 20 candidates / 371 applications.
